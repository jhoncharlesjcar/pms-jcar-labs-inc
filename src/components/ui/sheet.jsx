...
const sheetVariants = cva(
    "fixed z-50 gap-4 bg-background p-6 shadow-premium-lg transition ease-in-out data-[state=closed]:duration-200 data-[state=open]:duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out",
    {
        variants: {
            side: {
    ...
    <SheetPortal>
        ...
        <SheetPrimitive.Content ref={ref} className={cn(sheetVariants({ side }), className)} {...props}>
            {!props["aria-describedby"] && (
                <SheetPrimitive.Description className="sr-only">Panel lateral</SheetPrimitive.Description>
            )}
