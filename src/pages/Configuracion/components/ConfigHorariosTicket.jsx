            ...
            <div className="bg-card/40 backdrop-blur-xl rounded-xl border border-border/40 p-5 space-y-5 shadow-sm">
                <div className="flex items-center gap-3 border-b border-border/40 pb-4">
                    ...
                    <div>
                        ...
                        <p className="text-xs font-black uppercase tracking-widest text-muted-foreground mt-0.5">Hora estándar de entrada y salida</p>
                    </div>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                        <Label htmlFor="hora_checkin" className="text-xs font-black text-muted-foreground uppercase tracking-widest ml-1">Hora de Check-in</Label>
                    ...
                    <div className="space-y-1.5">
                        <Label htmlFor="hora_checkout" className="text-xs font-black text-muted-foreground uppercase tracking-widest ml-1">Hora de Check-out</Label>
            ...
            <div className="bg-card/40 backdrop-blur-xl rounded-xl border border-border/40 p-5 space-y-5 shadow-sm mt-4">
                <div className="flex items-center gap-3 border-b border-border/40 pb-4">
                    ...
                    <div>
                        ...
                        <p className="text-xs font-black uppercase tracking-widest text-muted-foreground mt-0.5">Se imprime al final de cada comprobante</p>
                    </div>
                </div>
                <div className="space-y-1.5">
                    <Label htmlFor="mensaje_ticket" className="text-xs font-black text-muted-foreground uppercase tracking-widest ml-1">Mensaje de agradecimiento</Label>
