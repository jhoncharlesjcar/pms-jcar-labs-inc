        ...
        <div className="bg-card/40 backdrop-blur-xl rounded-xl border border-border/40 p-5 space-y-5 shadow-sm">
            <div className="flex items-center gap-3 border-b border-border/40 pb-4">
                ...
                <div>
                    ...
                    <p className="text-xs font-black uppercase tracking-widest text-muted-foreground mt-0.5">Información fiscal y de contacto</p>
                </div>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="sm:col-span-2 space-y-1.5">
                    <Label htmlFor="hotel_nombre" className="text-xs font-black text-muted-foreground uppercase tracking-widest ml-1">Nombre del hospedaje *</Label>
                ...
                <div className="space-y-1.5">
                    <Label htmlFor="hotel_ruc" className="text-xs font-black text-muted-foreground uppercase tracking-widest ml-1">RUC *</Label>
                ...
                <div className="space-y-1.5">
                    <Label htmlFor="hotel_razon_social" className="text-xs font-black text-muted-foreground uppercase tracking-widest ml-1">Razón social *</Label>
                ...
                <div className="space-y-1.5">
                    <Label htmlFor="hotel_ciudad" className="text-xs font-black text-muted-foreground uppercase tracking-widest ml-1">Ciudad</Label>
                ...
                <div className="sm:col-span-2 space-y-1.5">
                    <Label htmlFor="hotel_direccion" className="text-xs font-black text-muted-foreground uppercase tracking-widest ml-1">Dirección fiscal *</Label>
                ...
                <div className="space-y-1.5">
                    <Label htmlFor="hotel_ubigeo" className="text-xs font-black text-muted-foreground uppercase tracking-widest ml-1">Ubigeo (6 dígitos) *</Label>
                ...
                <div className="space-y-1.5">
                    <Label htmlFor="hotel_departamento" className="text-xs font-black text-muted-foreground uppercase tracking-widest ml-1">Departamento</Label>
                ...
                <div className="space-y-1.5">
                    <Label htmlFor="hotel_provincia" className="text-xs font-black text-muted-foreground uppercase tracking-widest ml-1">Provincia</Label>
                ...
                <div className="space-y-1.5">
                    <Label htmlFor="hotel_distrito" className="text-xs font-black text-muted-foreground uppercase tracking-widest ml-1">Distrito</Label>
                ...
                <div className="space-y-1.5">
                    <Label htmlFor="hotel_telefono" className="text-xs font-black text-muted-foreground uppercase tracking-widest ml-1">Teléfono / WhatsApp</Label>
                ...
                <div className="space-y-1.5">
                    <Label htmlFor="hotel_email" className="text-xs font-black text-muted-foreground uppercase tracking-widest ml-1">Email</Label>
                ...
                <div className="sm:col-span-2 pt-2">
                    <div className="flex items-center justify-between p-4 bg-card/60 rounded-xl border border-border/40 shadow-sm transition-all hover:border-primary/30">
                        <div className="space-y-1">
                            ...
                            <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest">Desactiva esto si tu hotel se encuentra en la Amazonía (zona exenta de IGV).</p>
                        </div>
                        <Switch 
                            id="hotel_aplica_igv"
