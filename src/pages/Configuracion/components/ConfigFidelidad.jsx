            ...
            <div className="flex items-center justify-between border-b border-border/40 pb-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-[9px] font-black uppercase tracking-widest text-muted-foreground mt-0.5">Huéspedes frecuentes y recompensas</p>
                    </div>
                </div>

                <div className="flex flex-col items-end gap-1.5">
                    <Label htmlFor="loyalty-switch" className="text-[9px] font-black uppercase tracking-widest text-muted-foreground">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-1">
                <div className="p-4 bg-card/60 border border-border/40 rounded-xl space-y-1.5 shadow-sm transition-all hover:border-amber-500/30">
                    <div className="flex items-center gap-2 text-amber-500 mb-3">
                        ...
                        <span className="text-[9px] font-black uppercase tracking-widest text-foreground">Acumulación</span>
                    </div>
                    <p className="text-lg font-extrabold text-foreground tracking-tight">10 Puntos / Noche</p>
                    <p className="text-[10px] font-bold text-muted-foreground">Calculado al realizar check-out exitoso.</p>
                </div>
                ...
                <div className="p-4 bg-card/60 border border-border/40 rounded-xl space-y-1.5 shadow-sm transition-all hover:border-emerald-500/30">
                    <div className="flex items-center gap-2 text-emerald-500 mb-3">
                        ...
                        <span className="text-[9px] font-black uppercase tracking-widest text-foreground">Canje Recompensa</span>
                    </div>
                    <p className="text-lg font-extrabold text-foreground tracking-tight">100 Pts = 50% Desc.</p>
                    <p className="text-[10px] font-bold text-muted-foreground">Aplica en tarifa de habitación simple.</p>
                </div>
                ...
                <div className="p-4 bg-card/60 border border-border/40 rounded-xl space-y-1.5 shadow-sm transition-all hover:border-blue-500/30">
                    <div className="flex items-center gap-2 text-blue-500 mb-3">
                        ...
                        <span className="text-[9px] font-black uppercase tracking-widest text-foreground">Expiración</span>
                    </div>
                    <p className="text-lg font-extrabold text-foreground tracking-tight">12 Meses Inactivos</p>
                    <p className="text-[10px] font-bold text-muted-foreground">Reinicio a 0 si no se hospeda en 1 año.</p>
                </div>
            </div>

            <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-4 flex items-start gap-3 text-[10px] text-amber-600 dark:text-amber-400 font-bold shadow-xs">
